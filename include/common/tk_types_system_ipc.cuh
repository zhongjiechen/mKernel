/**
 * @file tk_types_system_ipc.cuh
 * @brief Inter-process communication handle types for sharing GPU memory across
 *        processes, supporting both legacy cudaIpc and VMM-based flavors.
 */
#pragma once
...
#include "tk_types_system_vmm.cuh"
