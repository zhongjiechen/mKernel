/**
 * @file tk_types_global_util.cuh
 * @brief Compile-time and runtime dimension types, TMA descriptor helpers, and
 *        global-layout utility traits for ThunderKittens tiles and vectors.
 */
#pragma once
